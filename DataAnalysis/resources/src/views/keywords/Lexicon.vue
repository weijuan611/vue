                    ...
                    <el-col :sm="7" :md="6" :lg="5">
                        <div class="bg">
                            <el-form-item label="添加人：" label-width="82px">
                                <el-input v-model="searchData.adder"></el-input>
                            </el-form-item>
                        </div>
                    </el-col>
            ...
            <el-table
                ...
                <el-table-column prop="score_pc" sortable="custom" width="110px" label="PC评价">
                    <template slot-scope="props">
                        ...
                        <span v-show="props.row.score_pc == 0" class="check_red">毫无推广</span>
                    </template>
                </el-table-column>
                <el-table-column prop="score_m" sortable="custom" width="110px" label="M评价">
                    <template slot-scope="props">
                        ...
                        <span v-show="props.row.score_m == 0" class="check_red">毫无推广</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="操作" header-align="center" fixed="right" width="320px">
