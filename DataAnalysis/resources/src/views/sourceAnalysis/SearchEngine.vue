<template>
    <page-wrap>
        ...
        <!-- 标题栏 -->
        <page-title title="来源分析-搜索引擎" :date="searchData.dateTime" />
        ...
        <search-wrap>
            <el-form ref="form" :model="searchData" size="mini">
                <el-form-item>
                    ...
                    <el-button type="success" @click="onExport" style="display: none;" :disabled=!buttonControl.search_engineimport>导出表格</el-button>
                </el-form-item>
            </el-form>
        </search-wrap>
        ...
        <!-- 其它的都放在这儿 -->
        <other-wrap>
          <rectangle :data="searchEngineDataDetail" cols="7" />
        ...
        methods: {
            ...
            onSubmit (action) {
                ...
                if (action !== 'changeSort' && action !== 'changeCurrentPage') {
                  ...
                  this.paginationData.order = 'ascending'
                }
                    ...
                    .then(function (res) {
                        if (res.data === 'ok') {
                            window.location = 'index.php/search_engine/import?start=' + that.searchData.dateTime[0]
                                + '&end=' + that.searchData.dateTime[1]  + '&prop=' + that.paginationData.prop + '&order=' + that.paginationData.order
                            ;
                        }
                    })
                    .catch(function(err) {
