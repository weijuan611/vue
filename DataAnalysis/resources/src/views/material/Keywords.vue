                ...
                <el-table-column label="操作" header-align="center" width="120px">
                    <template slot-scope="scope">
                        <el-button type="text" plain size="mini" icon="el-icon-delete"
                                   @click="onDelete(scope.row,0)" v-show="scope.row.status == 1" :disabled="!buttonControl.material_keywordlistmaterial_changetype">停用
                        </el-button>
                        <el-button type="text" plain size="mini" icon="el-icon-setting"
                                   @click="onDelete(scope.row,1)" v-show="scope.row.status == 0" :disabled="!buttonControl.material_keywordlistmaterial_changetype">激活
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
