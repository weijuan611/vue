  ...
  <table class="table1" cellspacing="0">
    <tr>
      <td colspan="2">
        ...
        <el-button icon="el-icon-search" size="mini" @click="keywordRadioShow = !keywordRadioShow"/>
        <b style="margin-left: 30px;">分类：</b>{{form.category}}
        <el-button slot="append" icon="el-icon-search" size="mini" @click="categoryShow = !categoryShow"/>
        <b style="margin-left: 30px;">已发文章：</b>{{form.article_num}}
        <el-button style="margin-left: 30px;" icon="el-icon-search" size="mini" type="primary" plain @click="articlesShow = !articlesShow">选择素材</el-button>
      </td>
    </tr>
    <tr>
      <td style="width: 50%;">
    ...
    <tr>
      <td colspan="3" class="buttons2">
        ...
        <el-button type="primary" size="mini" @click="saveMaterial">修改素材</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            insertKeywordFunc (keyword) {
                UE.getEditor('material_editor').execCommand('insertHtml', this.form.keyword);
            },
            filterAllTags (str) {
