<template>
    ...
    <el-dialog
        ...
        <el-form label-width="80px" ref="common_dialog_user_form"  size="mini">
            <el-form-item label="同义词一:">
                <el-input v-model="search.word" ></el-input>
            </el-form-item>
            <el-form-item label="同义词二:">
                <el-input v-model="search.synonym" ></el-input>
            </el-form-item>
        </el-form>
        <div slot="footer">
    ...
    export default {
        ...
        methods:{
            onSubmit:function () {
                ...
                this.loading = false
                this.$ajax.post('material_synonyms/material_addSynonyms', {search: that.search})
                    .then(function (res) {
