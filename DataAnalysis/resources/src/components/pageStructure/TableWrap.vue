...
export default {
  ...
  methods: {
    ...
    calculateTabTableHeight () {
      ...
      let widthTableHeaderHeight = currentTab.getElementsByClassName('withTableHeader').length > 0 ? currentTab.getElementsByClassName('withTableHeader')[0].offsetHeight : 0
      let bottomHeight = 77
